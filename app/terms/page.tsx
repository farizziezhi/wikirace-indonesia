            ...
            <div>
              ...
              <ul className="list-disc list-inside pl-2 flex flex-col gap-2">
                <li>
                  ...
                  <span className="block italic text-charcoal-text/75 pl-4">Use bots, automated scripts, or cheats to speed up navigation.</span>
                </li>
                <li>
                  <span>Melakukan eksploitasi celah keamanan (bug) sistem atau memanipulasi API.</span>
                  <span className="block italic text-charcoal-text/75 pl-4">Exploit security vulnerabilities (bugs) or manipulate APIs.</span>
                </li>
                <li>
                  <span>Mengirimkan spamming emoji atau chat reaksi yang mengganggu kenyamanan pemain lain.</span>
                  <span className="block italic text-charcoal-text/75 pl-4">Spam emojis or reaction chats that disturb other players.</span>
                </li>
              </ul>
              <p className="mt-3 text-burnt-orange font-bold">
              ...
              <p className="italic text-burnt-orange font-bold">
                Abuse of the above items may result in account suspension and permanent ELO deletion without prior notice.
              </p>
            </div>
